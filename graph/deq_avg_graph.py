...
file_path = "./results/switch/results_s1_read_packet_dequeuing_timedelta.txt"
...
file_path = "./results/switch/results_s2_read_packet_dequeuing_timedelta.txt"
with open(file_path, 'r') as file:
    for line in file:
        line = line.strip()
        if line:
...
file_path = "./results/switch/results_s1_cipher_read_packet_dequeuing_timedelta.txt"
with open(file_path, 'r') as file:
    for line in file:
        line = line.strip()
        if line:
...
file_path = "./results/switch/results_s2_cipher_read_packet_dequeuing_timedelta.txt"
with open(file_path, 'r') as file:
    for line in file:
        line = line.strip()
        if line:
...
# Specifica il percorso del file di testo
file_path = "./results/switch/results_s1_write_packet_dequeuing_timedelta.txt"
# Leggi i dati dal file, prendendo solo una riga ogni 4
with open(file_path, 'r') as file:
    for line in file:
        line = line.strip()  # Rimuovi spazi bianchi e caratteri di nuova riga
...
file_path = "./results/switch/results_s2_write_packet_dequeuing_timedelta.txt"
with open(file_path, 'r') as file:
    for line in file:
        line = line.strip()
        if line:
