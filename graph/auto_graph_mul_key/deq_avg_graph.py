...
file_path = "./results/mul_key/results_s1_read_packet_dequeuing_timedelta_array_128-bit.txt"
...
file_path = "./results/mul_key/results_s2_read_packet_dequeuing_timedelta_array_128-bit.txt"
with open(file_path, 'r') as file:
    for line in file:
        line = line.strip()
        if line:
...
# file_path = "./results/mul_key/results_s1_cipher_read_packet_dequeuing_timedelta.txt"
# with open(file_path, 'r') as file:
#     for line in file:
#         line = line.strip()
#         if line:
...
# file_path = "./results/mul_key/results_s2_cipher_read_packet_dequeuing_timedelta.txt"
# with open(file_path, 'r') as file:
#     for line in file:
#         line = line.strip()
#         if line:
...
# file_path = "./results/switch/results_s1_tls_read_packet_dequeuing_timedelta.txt"
# with open(file_path, 'r') as file:
#     for line in file:
#         line = line.strip()
#         if line:
...
# file_path = "./results/switch/results_s2_tls_read_packet_dequeuing_timedelta.txt"
# with open(file_path, 'r') as file:
#     for line in file:
#         line = line.strip()
#         if line:
...
# Specifica il percorso del file di testo
file_path = "./results/mul_key/results_s1_write_packet_dequeuing_timedelta_array_128-bit.txt"
# Leggi i dati dal file, prendendo solo una riga ogni 4
with open(file_path, 'r') as file:
    for line in file:
        line = line.strip()  # Rimuovi spazi bianchi e caratteri di nuova riga
...
file_path = "./results/mul_key/results_s2_write_packet_dequeuing_timedelta_array_128-bit.txt"
with open(file_path, 'r') as file:
    for line in file:
        line = line.strip()
        if line:
...
file_path = "./results/switch/results_s1_cipher_write_packet_dequeuing_timedelta.txt"
with open(file_path, 'r') as file:
    for line in file:
        line = line.strip()
        if line:
...
file_path = "./results/switch/results_s2_cipher_write_packet_dequeuing_timedelta.txt"
with open(file_path, 'r') as file:
    for line in file:
        line = line.strip()
        if line:
...
# file_path = "./results/switch/results_s1_tls_write_packet_dequeuing_timedelta.txt"
# with open(file_path, 'r') as file:
#     for line in file:
#         line = line.strip()
#         if line:
...
# file_path = "./results/switch/results_s2_tls_write_packet_dequeuing_timedelta.txt"
# with open(file_path, 'r') as file:
#     for line in file:
#         line = line.strip()
#         if line:
...
plt.bar(x_val, y_val_s1, color='tab:blue', label='Switch 1', width=0.5)#, yerr=[std_dev_r_s1, std_dev_r_encrypt_s1, std_dev_w_s1, std_dev_w_encrypt_s1], ecolor='red', capsize=5)
...
plt.bar(x_val, y_val_s2, color='tab:orange', label='Switch 2', bottom=y_val_s1, width=0.5)#, yerr=[std_dev_r_s2, std_dev_r_encrypt_s2, std_dev_w_s2, std_dev_w_encrypt_s2], ecolor='black', capsize=5)
...
plt.ylabel('Avg Packet Dequeuing Time (ms)', fontsize=13)
