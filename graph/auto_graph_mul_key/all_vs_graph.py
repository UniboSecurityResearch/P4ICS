...
file_path = "./results/results_10*10000_no_chiper_read.txt"
with open(file_path, 'r') as file:
    for line in file:
        line = line.strip()  # Rimuovi spazi bianchi e caratteri di nuova riga
        if line: 
...
file_path = "./results/results_10*10000_no_chiper_write.txt"
with open(file_path, 'r') as file:
    for line in file:
        line = line.strip()  # Rimuovi spazi bianchi e caratteri di nuova riga
        if line: 
...
file_path = "./results/tls/results_tls_read.txt"
with open(file_path, 'r') as file:
    for line in file:
        line = line.strip()  # Rimuovi spazi bianchi e caratteri di nuova riga
        if line: 
...
file_path = "./results/tls/results_tls_write.txt"
with open(file_path, 'r') as file:
    for line in file:
        line = line.strip()  # Rimuovi spazi bianchi e caratteri di nuova riga
        if line: 
