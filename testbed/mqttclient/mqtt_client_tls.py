...
ctx.load_verify_locations(cafile="./server_cert.crt")
ctx.load_cert_chain(certfile="./cert.crt", keyfile="key.key")
ctx.verify_mode = ssl.CERT_REQUIRED
mqttc.tls_set_context(ctx)

mqttc.on_connect = on_connect
mqttc.on_message = on_message
mqttc.on_publish = on_publish
mqttc.connect("200.1.1.8", 8883, keepalive=60)
